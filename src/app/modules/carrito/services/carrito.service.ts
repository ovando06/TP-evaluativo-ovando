...
export class CarritoService {
  ...
  //Creamos el modelo que va recibir los datos del pedido que se subirá a la base de datos.
  pedido: Pedido={
    idPedido:'',
    producto: {
      idProducto:'',
  ...
  constructor(
    ...
    //Creamos la subcoleciión dentro de la colección de usuarios y le damos ese valor
    //a pedidos pedidosColeccion
...
borrarPedido(pedido: Pedido){
  try {
    ...
    Swal.fire({
      ...
      text:'Ha borrado su producto con éxito!',
      icon:'info'
    })
  } catch (error) {
    Swal.fire({
